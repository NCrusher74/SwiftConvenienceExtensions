...
public extension Data {
    // MARK: - Int conversion
    /// Converts big endian `Data` instance to `Int`
    var intBE: Int {
        let signedInt = self.int64BE
        return Int(signedInt)
    }

    /// Converts little endian `Data` instance to `Int`
    var intLE: Int {
...
//    }
    var int64BE: Int64 {
    return Int64(parsing: self, .bigEndian)
    }

    var int64LE: Int64 {
        return Int64(parsing: self, .littleEndian)
    }
    
    var int32BE: Int32 {
        return Int32(parsing: self, .bigEndian)
    }
    
    var int32LE: Int32 {
        return Int32(parsing: self, .littleEndian)
    }
    
    var int16BE: Int16 {
        return Int16(parsing: self, .bigEndian)
    }
    
    var int16LE: Int16 {
        return Int16(parsing: self, .littleEndian)
    }
    
    var int8BE: Int8 {
        return Int8(parsing: self, .bigEndian)
    }
    
    var int8LE: Int8 {
        return Int8(parsing: self, .littleEndian)
    }
